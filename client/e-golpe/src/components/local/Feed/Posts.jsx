        ...
        <div className="buttons flex flex-row justify-between flex  p-[10px]">
          <div className="flex items-center space-x-4 justify-between">
            ...
            <div className=" posterPic w-12 h-12 border-1 border-transparent">
              <img src={user.profilePicture} alt="post image" className=" py-2 px-2 w-12 h-12 rounded-full object-cover border-2 border-indigo-500" />
            </div>
        ...
        <div className="interaction">
          <div className="buttons flex flex-row justify-between">
            <ul className="flex space-x-2 border-1 border-transparent py-2 px-2">
              <li>
                <button className="ring-1 ring-indigo-600 flex flex-row items-center justify-center py-2 px-2 h-10 w-30 rounded-lg text-indigo-600 hover:text-white hover:bg-indigo-600"
              ...
              <li> 
                <button className="flex flex-row ring-1 ring-indigo-600 flex items-center justify-center py-2 px-2 h-10 w-30 rounded-lg text-indigo-600 hover:text-white hover:bg-indigo-600">
