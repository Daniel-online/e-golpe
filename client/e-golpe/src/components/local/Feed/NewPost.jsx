      ...
      <form action="">
        ...
        <div className=" px-6 py-4 border-4 border-transparent place-content-end text-white inputBar space-x-8 flex flex-row w-full py-px">
          <ul className="space-x-4 text-sm flex place-content-evenly">
            <button className="flex items-center justify-center py-px h-8 w-8 rounded-lg bg-cyan-600 hover:text-yellow-400" type="file" id="post" name="post" accept="image/png, image/jpeg" >
              <ImImage></ImImage>
            </button>
            <button className="flex items-center justify-center py-px h-8 w-8 rounded-lg bg-cyan-600 hover:text-yellow-400" type="file" id="post" name="post" accept="pdf" >
              <CiFileOn></CiFileOn>
            </button>
            <button className="flex items-center justify-center py-px h-8 w-8 rounded-lg bg-cyan-600 hover:text-yellow-400" type="file" id="post" name="post" accept="pdf" >
