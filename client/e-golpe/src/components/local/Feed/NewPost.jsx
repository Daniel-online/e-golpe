...
const NewPost = () => {
  ...
  return (
    <div className="shadow-lg wrapper bg-white border-s border-slate-300 rounded-lg items-center">
      <form>
        <div className="top border-transparent border-x-4 border-y-4 flex items-center space-x-4 space-y-2">
          ...
          <div className=" py-px top textBox text-lg max-w-max border-1 border-transparent ">
            <textarea className="ring-1 ring-slate-300 rounded-lg  border-1 border-slate-100" name="message" id="textbox" rows="3" cols="40"></textarea>
          </div>
        </div>

        <div className=" px-6 py-3 border-4 border-transparent place-content-end text-white inputBar space-x-8 flex flex-row w-full py-px">
